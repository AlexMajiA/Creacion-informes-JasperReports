...
public class GestionAlumnos {
    ...
    public static ArrayList<Alumnos> crearAlumno() {
        ...
        BD.add(new Alumnos("68713555F", "DI", 5.8, "JAEN"));
        BD.add(new Alumnos("41668219W", "DI", 6.9, "CORODOBA"));
        BD.add(new Alumnos("72345565S", "DI", 8.3, "CADIZ"));
        BD.add(new Alumnos("35799524Y", "DI", 9.1, "ALMERIA"));
        BD.add(new Alumnos("87765691J", "DI", 7.4, "CADIZ"));
        BD.add(new Alumnos("16584863P", "DI", 8.5, "JAEN"));
        BD.add(new Alumnos("78998215E", "DI", 9.5, "CORODOBA"));
        ...
        BD.add(new Alumnos("13540213A", "PMDM", 7.5, "JAEN"));
        BD.add(new Alumnos("11654521L", "PMDM", 5.5, "CORODOBA"));

        BD.add(new Alumnos("77899451K", "AD", 7.4, "CADIZ"));
        BD.add(new Alumnos("35444321B", "AD", 8.5, "CORODOBA"));
        BD.add(new Alumnos("91352153A", "AD", 6.9, "MALAGA"));
        BD.add(new Alumnos("75321621M", "AD", 8.4, "JAEN"));
        BD.add(new Alumnos("35448776P", "AD", 9.6, "GRANADA"));

        BD.add(new Alumnos("13225215F", "PSP", 7.4, "JAEN"));
